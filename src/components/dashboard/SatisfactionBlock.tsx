...
const topicsData = [
  { topic: "การดูแล ความเอาใจใส่", negative: 11, positive: 20, total: 31, score: 4.4 },
  { topic: "ความน่าเชื่อถือการตอบคำถามและแนะนำ", negative: 32, positive: 64, total: 96, score: 4.1 },
  { topic: "ความรวดเร็วในการให้บริการ", negative: 22, positive: 53, total: 75, score: 4.2 },
  { topic: "ความถูกต้องในการทำธุรกรรม", negative: 43, positive: 54, total: 97, score: 4.1 },
  { topic: "ความพร้อมของเครื่องมือ", negative: 33, positive: 66, total: 99, score: 4.2 },
  { topic: "สภาพแวดล้อมของสาขา", negative: 44, positive: 52, total: 96, score: 4.0 },
  { topic: "ความประทับใจในการให้บริการ", negative: 23, positive: 44, total: 77, score: 4.4 }
];
  ...
  return (
    <Card className="rounded-2xl border shadow-card bg-white overflow-hidden">
      ...
      <CardContent className="space-y-6 p-6 pt-0">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-kanit text-lg font-semibold text-foreground">การวิเคราะห์ความคิดเห็นตามหัวข้อ</h3>
            <Select 
              value={selectedTopic}
