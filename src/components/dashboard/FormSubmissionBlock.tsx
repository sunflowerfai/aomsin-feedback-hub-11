      ...
      <div className="text-center">
        <div className="flex items-center justify-center gap-1 text-xs">
          ...
          <span className="font-kanit text-gray-600">
            (จากเดือนที่แล้ว {data.previousValue.toLocaleString()} ครั้ง)
          </span>
        </div>
      </div>
    </div>
      ...
      <CardContent className="space-y-6 p-6 pt-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <h3 className="font-kanit text-lg font-semibold text-foreground">ประเภทของสาขา</h3>
            <div className="h-64">
          ...
          {/* Bar Chart */}
          <div className="space-y-4">
            <h3 className="font-kanit text-lg font-semibold text-foreground">ประเภทการใช้บริการ</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
