...
const branchTypeData = [
  { name: "สาขาเต็มรูปแบบ", value: 65.2, count: 342, color: "hsl(var(--tertiary))" },
  { name: "สาขาขนาดเล็ก", value: 34.8, count: 182, color: "hsl(var(--dashboard-blue-bg))" }
];
                ...
                <PieChart>
                  ...
                  <Tooltip 
                    formatter={(value: any, name: string, props: any) => [
                      `${value}% (${props.payload.count} แห่ง)`,
                      'สัดส่วน'
                    ]}
